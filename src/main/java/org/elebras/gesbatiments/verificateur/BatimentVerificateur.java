...
/**
 * Classe permettant de vérifier la conformité de la numérotation des pièces et des étages dans un
 * bâtiment.
 */
public class BatimentVerificateur {

  /**
   * Vérifie la numérotation des pièces d'un bâtiment. Les numéros de pièces doivent être dans un
   * ordre croissant.
   *
   * @param batiment le bâtiment à vérifier, contenant une liste de pièces.
   * @return un {@link VerificationResultat} indiquant si une erreur est détectée dans la
   *         numérotation des pièces, ou aucune erreur.
   */
  ...
  /**
   * Vérifie la numérotation des étages d'un bâtiment. Les numéros des étages doivent être dans un
   * ordre croissant.
   *
   * @param batiment le bâtiment à vérifier, contenant une liste d'étages.
   * @return un {@link VerificationResultat} indiquant si une erreur est détectée dans la
   *         numérotation des étages, ou aucune erreur.
   */
  ...
  /**
   * Effectue une vérification complète d'un bâtiment. Cette méthode vérifie successivement la
   * numérotation des étages, puis celle des pièces.
   *
   * @param batiment le bâtiment à vérifier, contenant une liste d'étages et de pièces.
   * @return un {@link VerificationResultat} indiquant si une erreur est détectée dans la
   *         numérotation des étages ou des pièces, ou aucune erreur. La vérification des étages est
   *         prioritaire sur celle des pièces.
   */
