...
/**
 * Contrôleur principal de l'application qui gère l'affichage des vues du campus. Cette classe étend
 * {@link Application} et permet d'ouvrir différentes vues de l'application, telles que la liste des
 * bâtiments et les détails d'un bâtiment spécifique.
 */
public class VueController extends Application {
  ...
  /**
   * Constructeur de la classe {@code VueController}. Initialise l'instance de {@code Campus}.
   */
  ...
  /**
   * Méthode de démarrage de l'application. Elle est appelée lors du lancement de l'application
   * JavaFX. Elle appelle la méthode {@link #ouvrirVueListeBatiments(Stage)} pour afficher la vue
   * des bâtiments.
   *
  ...
  /**
   * Ouvre la vue contenant la liste des bâtiments. Charge le fichier FXML associé et définit le
   * contrôleur pour la vue des bâtiments.
   *
  ...
  /**
   * Ouvre la vue d'un bâtiment spécifique en fonction de son numéro. Charge le fichier FXML associé
   * et définit le contrôleur pour la vue du bâtiment.
   *
