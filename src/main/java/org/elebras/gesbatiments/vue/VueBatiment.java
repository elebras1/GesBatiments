...
/**
 * Classe représentant la vue d'un bâtiment dans l'application. Elle gère l'affichage et la
 * modification des informations liées à un bâtiment ainsi que l'interaction avec l'utilisateur pour
 * la mise à jour du nom du bâtiment. Cette classe implémente le patron de conception Observer afin
 * de réagir aux changements dans l'état du campus.
 */
public class VueBatiment implements Observer {
  ...
  /**
   * Initialise la vue du bâtiment, affiche les informations du bâtiment et met à jour l'interface
   * avec les données actuelles.
   */
  public void initialize() {
    this.batimentInfoTextArea
        .setText(this.campus.afficherBatiment(new BatimentVisiteur(), this.numeroBatiment));
    this.update();
  }
  ...
  /**
   * Méthode appelée pour afficher les informations des bureaux via le visiteur BureauxVisiteur. Met
   * à jour la zone de texte avec les informations des bureaux du bâtiment.
   */
  @FXML
  public void afficherVisiteurBureaux() {
    this.batimentInfoTextArea
        .setText(this.campus.afficherBatiment(new BureauxVisiteur(), this.numeroBatiment));
  }

  /**
   * Méthode appelée pour modifier le nom du bâtiment. Si le champ est vide ou si le nom est déjà
   * pris, une alerte est affichée.
   */
  @FXML
  public void modifierNomBatiment() {
    ...
    if (nomBatiment == null) {
      this.afficherAlerte("Erreur", "Nom de bâtiment déjà existant",
          "Veuillez choisir un autre nom.");
    }
  }

  /**
   * Méthode de mise à jour appelée lorsque le campus change. Elle met à jour le nom du bâtiment
   * dans le champ texte.
   */
  @Override
  public void update() {
