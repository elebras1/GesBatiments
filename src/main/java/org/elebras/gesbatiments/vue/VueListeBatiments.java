...
/**
 * Contrôleur de la vue de la liste des bâtiments. Cette classe gère l'affichage et les actions liées à la
 * gestion des bâtiments dans l'interface utilisateur, incluant l'ajout, la suppression, et l'affichage des
 * bâtiments à partir d'un fichier JSON.
 *
 * Elle implémente l'interface {@link Observer} pour mettre à jour l'affichage lorsque des modifications
 * sont effectuées sur l'état du {@link Campus}.
 */
public class VueListeBatiments implements Observer {
    ...
    /**
     * Ouvre un fichier JSON pour ajouter des bâtiments en fonction de son contenu.
     * Affiche un bilan d'ajout des bâtiments après l'importation du fichier.
     *
     * @param actionEvent l'événement déclenché par l'action de l'utilisateur.
     */
    @FXML
    ...
    /**
     * Met à jour l'affichage de la liste des bâtiments lorsque des modifications sont effectuées sur le campus.
     */
    @Override
    public void update() {
