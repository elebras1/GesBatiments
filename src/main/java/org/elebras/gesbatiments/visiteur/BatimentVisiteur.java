...
/**
 * La classe {@code BatimentVisiteur} implémente l'interface {@link Visiteur} et fournit une
...
public class BatimentVisiteur implements Visiteur {
  ...
  public void visite(Piece piece) {
    this.result.append("        Pièce ").append(piece.getNumero()).append(" - Surface: ")
        .append(piece.getSurface()).append(" m²\n");
  }
