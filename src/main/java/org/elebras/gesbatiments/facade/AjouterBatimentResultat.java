...
/**
 * Représente les différents résultats possibles lors de l'ajout d'un bâtiment. Cette énumération
 * permet d'indiquer si l'ajout d'un bâtiment a réussi ou a échoué, et si l'échec est dû à un
 * bâtiment déjà existant ou à des paramètres invalides.
 */
