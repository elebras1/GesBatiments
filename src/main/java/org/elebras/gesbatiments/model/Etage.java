...
/**
 * Représente un étage dans un bâtiment, identifié par son numéro.
 * Cette classe implémente l'interface {@link Visitable} permettant l'application d'un visiteur sur cet étage.
 */
public class Etage implements Visitable {
    ...
    /**
     * Compare cet étage avec un autre objet pour vérifier s'ils sont égaux.
     * Deux étages sont considérés égaux s'ils ont le même numéro.
     *
    ...
    /**
     * Retourne le code de hachage pour cet étage. Le code de hachage est basé sur le numéro de l'étage.
     *
