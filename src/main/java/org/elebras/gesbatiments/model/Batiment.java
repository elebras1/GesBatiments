...
/**
 * Représente un bâtiment dans le système, avec des informations telles que son numéro, son nom,
 * son usage, les pièces qu'il contient et les étages.
 * Cette classe implémente l'interface {@link Visitable} permettant l'application d'un visiteur sur
 * le bâtiment et ses composants (étages et pièces).
 */
public class Batiment implements Visitable {
    ...
    /**
     * Accepte un visiteur pour appliquer un traitement sur ce bâtiment et ses composants (étages et pièces).
     *
    ...
    /**
     * Compare ce bâtiment avec un autre objet pour vérifier s'ils sont égaux.
     * Deux bâtiments sont considérés égaux s'ils ont le même numéro et nom.
     *
    ...
    /**
     * Retourne le code de hachage pour ce bâtiment. Le code de hachage est basé sur le numéro et le nom du bâtiment.
     *
