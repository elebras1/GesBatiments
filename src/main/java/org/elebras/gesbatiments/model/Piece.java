...
/**
 * Représente une pièce d'un bâtiment, avec des attributs tels que sa surface, son numéro et son étage associé.
 * Cette classe implémente l'interface {@link Visitable} permettant l'application d'un visiteur sur la pièce.
 */
