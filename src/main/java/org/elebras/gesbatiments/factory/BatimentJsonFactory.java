...
/**
 * La classe BatimentJsonFactory fournit des méthodes pour gérer la sérialisation et la
 * désérialisation des objets {@link Batiment} en format JSON à l'aide de la bibliothèque Jackson.
 * Elle permet de créer un fichier JSON contenant une liste de bâtiments et de lire un fichier JSON
 * pour créer une liste de bâtiments.
 */
