...
class BatimentTest {
  ...
  void setUp() {
    ...
    this.batiment = new Batiment(1, "Batiment A", "Commercial",
        Arrays.asList(this.piece1, this.piece2), Arrays.asList(this.etage1, this.etage2));
  }
  ...
  @Test
  void testEquals() {
    Batiment batiment2 = new Batiment(1, "Batiment A", "Commercial",
        Arrays.asList(this.piece1, this.piece2), Arrays.asList(this.etage1, this.etage2));
