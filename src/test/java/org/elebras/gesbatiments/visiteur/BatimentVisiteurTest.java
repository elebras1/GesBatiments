...
class BatimentVisiteurTest {
    ...
    void testVisiteBatiment() {
        Batiment batiment = new Batiment(1, "Bâtiment A", "Commercial", new ArrayList<>(), new ArrayList<>());
    ...
    void testVisiteEtage() {
        ...
        Batiment batiment = new Batiment(1, "Bâtiment A", "Commercial", new ArrayList<>(), Arrays.asList(etage));
        BatimentVisiteur visiteur = new BatimentVisiteur();
        batiment.accept(visiteur);
        String expected = "Bâtiment Bâtiment A (1)\n    Etage 1:\n";
        assertEquals(expected, visiteur.getResult());
    ...
    void testVisitePiece() {
        ...
        Batiment batiment = new Batiment(1, "Bâtiment A", "Commercial", Arrays.asList(piece), Arrays.asList(etage));
        BatimentVisiteur visiteur = new BatimentVisiteur();
        batiment.accept(visiteur);
    ...
    void testVisiteBatimentAvecPlusieursEtagesEtPieces() {
        ...
        Batiment batiment = new Batiment(1, "Bâtiment A", "Commercial", Arrays.asList(piece1, piece2, piece3), Arrays.asList(etage1, etage2));
        BatimentVisiteur visiteur = new BatimentVisiteur();
        batiment.accept(visiteur);
        String expected = "Bâtiment Bâtiment A (1)\n" +
                "    Etage 1:\n" +
